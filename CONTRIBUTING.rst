Designate (DNSaaS) for Rackspace Private Cloud
################
:tags: openstack, rpc, cloud, ansible, designate
:category: \*nix
...
Bugs should be filed in a JIRA: "https://bit.ly/RPC-openstack-template"
