# -*- coding: utf-8 -*-
"""
RPC designate documentation build configuration file.
...
rst_epilog = """
.. |product name| replace:: RPC Designate
"""
...
exclude_patterns = ['_build', 'samples', 'README.rst', '.tox']

if internal is False:
    exclude_patterns.extend(['internal'])
...
extlinks = {
    ...
    'mycloud': ('https://login.rackspace.com', ''),
